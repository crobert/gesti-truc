...
<h2 class="titrePage">&Eacute;léments de <?php echo $c->name; ?> <a title="nouvel élément" href="<?php echo site_url('items/add/'.$c->id); ?>"><i class="glyphicon glyphicon-plus"></i></a></h2>
